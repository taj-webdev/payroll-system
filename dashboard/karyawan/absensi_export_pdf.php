...
<head>
    <style>
        ...
        .sub { text-align:center; font-size:11px; margin-bottom:15px; }
        ...
        .badge { padding:4px 8px; border-radius:8px; color:#fff; font-size:10px; }
...
foreach ($data as $r) {
    ...
    <tr>
        ...
        <td align="center"><span class="badge '.$r['status'].'">'.$r['status'].'</span></td>
...
$dompdf->render();
$dompdf->stream('absensi_saya.pdf', ['Attachment' => false]);
exit;
